...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/rhdhpai581-test3](https://github.com/rhdh-JslYoon-org/rhdhpai581-test3)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/rhdhpai581-test3-gitops](https://github.com/rhdh-JslYoon-org/rhdhpai581-test3-gitops)

# **Usage**

To access the rhdhpai581-test3 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of rhdhpai581-test3. You can access this namespace through the web console or via your CLI.
